...
This project is indexed by GitNexus as **cherry-picker** (1490 symbols, 2668 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
